...
const useStyles = makeStyles((theme) => ({
    ordersHead: {
        ...
        '@media (max-width: 1059px) and (min-width: 960px)': {
            fontSize: '0.746rem'
        },
    },
    userOrders: {
        ...
        <div>
            ...
            <div style={{ display: 'flex' }}>
                <Card className={clsx(classes.userOrders, classes.marginRig)}>
                    <Typography variant="body2" className={classes.ordersHead}>{t("inc orders")}</Typography>
                ...
                <Card className={clsx(classes.userOrders, classes.marginLef)}>
                    <Typography variant="body2" className={classes.ordersHead}>{t("outgo orders")}</Typography>
