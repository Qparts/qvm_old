              ...
              <Box display="flex" justifyContent="flex-end" position="relative">
                ...
                <article className={classes.artical}>
                      <Typography variant="h3" mb={2} className={classes.articleHeading}>
                        بإمكانك معرفة مكان توفر القطعة وسعرها
                      </Typography>
                      <p className={classes.articleDisc}>
                        لن يضيع المزيد من الوقت  في المكالمات والفاكسات والايميلات للبحث عن القطع التي تريدها ومعرفة سعرها ، قد تكون موجوده عند التاجر الذي يبعد عنك امتار!! عن طريق QVM تستطيع خلال ثواني مقارنة السعر والتواصل مباشرة مع المورد لحجزها
                      </p>
                    </article>
                </MotionInView>
